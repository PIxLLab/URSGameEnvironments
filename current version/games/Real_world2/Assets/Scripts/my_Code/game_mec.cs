...
public class game_mec : MonoBehaviour
{
    ...
    void Start()
    {
      //  string filepath = @"C:\Users\User\Desktop\newdz.kml";
        string filepath = @"C:\Users\GDC-Admin\Desktop\newsetting\new_mat_version2_2.kml";
        string filepath2 = @"C:\Users\GDC-Admin\Desktop\newsetting\config2.xml";
            ...
            foreach (XmlNode xn in transformList)
            {
                ...
                if (xn["name"].InnerText.StartsWith("dc"))
                {
                    ...
                    for (int i = 8; i < singlevector.Length-8; ++i)
                    {
                        ...
                        result = new Vector3((float)longid, (float)27, (float)latd);
                ...
                if (xn["name"].InnerText.StartsWith("hc"))
                {
                    ...
                    for (int i = 8; i < singlevector.Length-8; ++i)
                    {
                        ...
                        result = new Vector3((float)longid, (float)23, (float)latd);
